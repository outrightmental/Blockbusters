...
const PLAYER_SCORE_INITIAL: int                         = 3
const PLAYER_SCORE_VICTORY: int                         = 10
...
const EXPLOSION_CRITICAL_RADIUS_BLOCK_BREAK_LEVEL_1_RATIO: float   = 0.4
const EXPLOSION_CRITICAL_RADIUS_BLOCK_BREAK_LEVEL_2_RATIO: float   = 0.4
const EXPLOSION_CRITICAL_RADIUS_BLOCK_BREAK_LEVEL_3_RATIO: float   = 0.4
